<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="home"><i class="fa fa-dashboard fa-fw"></i> Trang chủ</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="admin/food/list"><i class="fa fa-bar-chart-o fa-fw"></i> Thực đơn<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/food/list"> Danh sách</a>
                                </li>
                                <li>
                                    <a href="admin/food/add"> Thêm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
