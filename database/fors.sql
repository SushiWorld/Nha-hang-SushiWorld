...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 14, 2021 lúc 04:22 PM
...
INSERT INTO `food` (`id`, `food_name`, `food_price`, `food_description`, `cate_id`, `food_img`, `highlight`, `updated_at`, `created_at`) VALUES
(1, 'Bánh xèo Nhật', '80K', 'Bánh xèo chuẩn hương vị Nhật độc quyền của Nhà hàng Sushi World.', 1, '', '', '0000-00-00', '0000-00-00'),
(2, 'Pizza hải sản Nhật', '145K', 'Pizza gồm cá thu Nhật, mực, tôm, hàu, sốt cà chua Nhật.', 1, '', '', '0000-00-00', '0000-00-00'),
(3, 'Salad rau quả', '40K', 'Gồm hành tây, hành củ tím, cà chua bi, rau salack, giấm nhật, sốt mayonnaise.', 1, '', '', '0000-00-00', '0000-00-00'),
(4, 'Măng tây áp chảo', '70K', 'Măng tây bổ sung chất xơ và cung cấp nhiều chất dinh dưỡng tốt cho sức khỏe.', 1, '', '', '0000-00-00', '0000-00-00'),
(5, 'Dưa chuột chấm sốt Miso', '70K', 'Dưa chuột Nhật chấm với nước sốt Miso ngọt cay nồng.', 1, '', '', '0000-00-00', '0000-00-00'),
(6, 'Súp Miso', '55K', 'Gồm nước dùng Dashi kết hợp tương Miso, đậu phụ, rong biển.', 1, '', '', '0000-00-00', '0000-00-00'),
(7, 'Maki', '50K', 'Maki Sushi cơm cuộn rong biển gồm 1 nhân đủ loại thuần truyền thống.', 2, '', '', '0000-00-00', '0000-00-00'),
(8, 'Futomaki', '55K', 'Futomaki Sushi cơm cuộn rong biển gồm 2-3 nhân đủ loại thuần truyền thống.', 2, '', '', '0000-00-00', '0000-00-00'),
(9, 'Gunkan', '70K', 'Gunkan Sushi như một chiếc tàu nhỏ đầy các món cá, trứng cá, trứng tôm, nhím biển..', 2, '', '', '0000-00-00', '0000-00-00'),
(10, 'Temari', '60K', 'Temari Shushi tròn như quả bóng nhiều loại topping khác nhau tùy theo lựa chọn.                       ', 2, '', '', '0000-00-00', '0000-00-00'),
(11, 'Temaki', '70K', 'Temaki có hình chiếc phễu, bên trong cuộn cơm và cá hồi, trứng cá hồi, rau củ...', 2, '', '', '0000-00-00', '0000-00-00'),
